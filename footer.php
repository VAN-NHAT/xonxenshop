<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<div class="contact">			
					<p class="bold">XON XEN SHOP</p>
					<p><i class="fa fa-map-marker"></i>Hải Châu-Đà Nẵng</p>
	              	<p><i class="fa fa-envelope"></i>vnct112233@gmail.com</p>
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<ul class="connect">
					<li><a href="http://facebook.com/nhat270120"><i class="fa fa-facebook"></i></a></li>
